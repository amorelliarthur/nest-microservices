...
export class CreateTables1779215751116 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."accounts_type_enum" AS ENUM('CHECKING', 'SAVINGS')`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b9d2f8434bdcdf20f2a829fe77" ON "transactions" ("account_id", "created_at") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b9d2f8434bdcdf20f2a829fe77"`,
    );
